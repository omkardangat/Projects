...
<body>
	<%	ContactDriver driver = new ContactDriver();
		...
		String inputEmail = session.getAttribute("inputEmail").toString();
		int count = driver.updateContact(inputEmail, contact);
		if(count > 0) {
	%>
		<h2> Contact has been update </h2>
	<% } else { %>
		<h2> Error in processing contact update </h2>
	<% } %>
